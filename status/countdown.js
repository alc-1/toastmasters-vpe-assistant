...
// are opened, in lib/basecamp-api.js / lib/easyspeak-api.js). Each page
// including this script must define #countdownText (the sentence, replaced
// on cancel), #countdown (the number inside it), and #cancelBtn.
